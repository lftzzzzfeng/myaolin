...
<div class="relative">
    <img src="<?php echo base_url() ?>ui/img/mobile/xing.jpg" width="100%" alt=""/>
    <div class="banner_txt  col-xs-6 col-sm-4 col-xs-offset-3 col-sm-offset-4 tex-white text-center">
        ...
        <p class="size-18 weight-800 margin-bottom-5 ipad_size">行在瑶琳</p>

        <p class="p3 size-12 color_blue margin-bottom-5"><span>NICE TRIP</span><br/><span>TRAVEL SERVICE</span></p>
    		
    </div>
    <div class="you_fh" onclick="window.history.go(-1);">
        <a>
            <img src="<?php echo base_url() ?>ui/img/mobile/fanhui.png" style="height:60%;width: 50%"/>
        </a>
    </div>
...
<div class="xing_con">
    <p class="xing_p">瑶琳森林公园位于320国道西北侧，处在02省道与08省道交汇点上，杭州市内于汽车西站乘坐长途汽车至桐庐，再由桐庐乘坐中巴车可前往景区；或者在杭州汽车南站乘坐前往分水方向的车，途经通天河到达本公园。<br />同时，该场地处“杭州一千岛湖一黄山”旅游线中段，距离千岛湖70公里车程，“瑶琳仙境”“瑶琳垂云洞”“竹筏漂游天目溪”等旅游项目相连，开辟成为森林公园，将成为浙西的第一大旅游环；该园与320国道、05省道、杭新景高速相连，直通景区开辟国家级公路，交通便捷。距杭州直线距离75公里，西接黄山、千岛湖，东连钱塘江、西湖，属于国家重点风景名胜区。</p>
    <img src="<?php echo base_url() ?>ui/img/mobile/xing_1.jpg"  />
    <img src="<?php echo base_url() ?>ui/img/mobile/xing_2.jpg"  />
    <img src="<?php echo base_url() ?>ui/img/mobile/xing_3.jpg"  />
</div>