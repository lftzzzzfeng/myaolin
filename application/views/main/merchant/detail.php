...
<div class="gr_con">
    ...
    <div class="panes">
        <div class="pane" style="display:block;">
            <div class="zl_sc">
                <p class="zl_p"><span>*</span>上传个人头像</p>
                <div class="zl_pc">
                    <a href="#"><img src="<?php echo base_url() ?>ui/img/mobile/tx.png"  /></a>
                    <p>点击头像进行上传</p>
                </div>
            </div>
            <div class="zl_sca">
                <div class="zl_name">
                    ...
                    <div class="zl_namer">
                        <input type="text" name="textfield" id="textfield" placeholder="请输入本人真实姓名" />
                    </div>
                </div>
                <div class="zl_name">
                    <div class="zl_namel"><p><span>*</span>身份证号码</p></div>
                    <div class="zl_namer">
                        <input type="text" name="textfield" id="textfield" placeholder="请输入本人身份证号码" />
                    </div>
                </div>
                <div class="zl_name">
                    <div class="zl_namel"><p><span>*</span>电话号码</p></div>
                    <div class="zl_namer">
                        <input type="text" name="textfield" id="textfield" placeholder="请输入11位手机号码" />
                    </div>
                </div>
                <div class="zl_name">
