...
<!--banner-->
<div class="relative">
    <img src="<?php echo base_url() ?>ui/img/mobile/gou_banner.jpg" width="100%" alt=""/>
    <div class="banner_txt  col-xs-6 col-sm-4 col-xs-offset-3 col-sm-offset-4 tex-white text-center">
        ...
        <p class="size-25 weight-800 margin-bottom-5 ipad_size">购在瑶琳</p>
	...
	<div class="gou_con">
		<div class="gou_bt"><p>纪念品专区</p></div>
		<div class="gou_pin">
			<ul>
				<li>
					<img src="<?php echo base_url() ?>ui/img/mobile/gou_1.jpg"  />
					<p>手工雕刻猫头鹰</p>
				</li>
				<li class="gou_li">
					<img src="<?php echo base_url() ?>ui/img/mobile/gou_2.jpg"  />
					<p>手工雕刻猫头鹰</p>
				</li>
				<li>
					<img src="<?php echo base_url() ?>ui/img/mobile/gou_1.jpg"  />
			...
			<div class="gou_btn"><a href="#">查看更多<img style="width:18px;" src="<?php echo base_url() ?>ui/img/mobile/icon_btn_03.png" /></a></div>
		</div>
		<div class="gou_bt"><p>纪念品专区</p></div>
		<div class="gou_pin">
			<ul>
				<li>
					<img src="<?php echo base_url() ?>ui/img/mobile/gou_3.jpg"  />
					<p>美容养颜蛋白粉</p>
				</li>
				<li class="gou_li">
					<img src="<?php echo base_url() ?>ui/img/mobile/gou_4.jpg"  />
					<p>灵芝盖寿胶囊</p>
				</li>
				<li>
					<img src="<?php echo base_url() ?>ui/img/mobile/gou_5.jpg"  />
					<p>美容养颜蛋白粉</p>
				</li>
				<li class="gou_li">
					<img src="<?php echo base_url() ?>ui/img/mobile/gou_3.jpg"  />
