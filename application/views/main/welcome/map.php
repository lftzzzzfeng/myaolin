...
<div class="yj_top" style="background: #f8f8f8;height:52px;">
	<p style="line-height:50px;">瑶琳地图</p>
	<div class="yj_left" onclick="window.history.go(-1);"><a><img src="<?php echo base_url() ?>ui/img/mobile/yj_fh.png" style="height:80%;width: 70%;margin-top: 16px;"/></a></div>
</div>
<!--百度地图容器-->
<div style="width:414px;height:550px;border:#ccc solid 1px;" id="dituContent"></div>
</body>
<script type="text/javascript">
	...
	function createMap(){
		...
		var point = new BMap.Point(119.552177,29.938839);//定义一个中心点坐标
	...
	//标注点数组
	var markerArr = [{title:"瑶琳森林公园",content:"我的备注",point:"119.54384|29.945098",isOpen:0,icon:{w:23,h:25,l:46,t:21,x:9,lb:12}}
	];
	//创建marker
	function addMarker(){
