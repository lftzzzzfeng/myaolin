<div id="content" class="col-lg-10 col-sm-10">
    <div>
        <ul class="breadcrumb">
            ...
            <li>
                <a href="<?php echo base_url(); ?>admin/scenicView/edit/<?php echo $id ?>">编辑景点介绍</a>
            </li>
        </ul>
    </div>
    <div class="row">
        <div class="box col-md-12">
            <div class="box-inner">
                ...
                <div class="box-content">
                    <form id="frmContent" role="form" method="POST" action="<?php echo base_url(); ?>admin/scenicView/edit/<?php echo $id ? $id : ''; ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="fileScenicViewImages">多照片<em>(选择多张照片 ctrl + 鼠标左键)</em></label>
                            <input name="scenicViewImages[]" id="fileScenicViewImages" class="btn btn-default" type="file" onchange="previewFiles()" multiple>
                        </div>
                        <div class="form-group">
                            <div id="preview">
<?php if ((isset($showScenicViewImages)) && count($showScenicViewImages) > 0): ?>
    <?php foreach ($showScenicViewImages as $scenicViewImage): ?>
                                <img style="height: 100px; width: 100px; margin: 2px; padding: 2px; border: 1px solid" src="<?php echo $scenicViewImage ?>" />
    <?php endforeach; ?>
<?php endif; ?>
                            </div>
                        </div>
                        <a class="btn btn-primary" href="<?php echo base_url();?>admin/scenicView">
...
<script type="text/javascript">
    ...
    function previewFiles() {
        ...
        var files = document.querySelector('#fileScenicViewImages').files;
        preview.innerHTML = '';
