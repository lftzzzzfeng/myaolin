<div id="content" class="col-lg-10 col-sm-10">
    <div>
        <ul class="breadcrumb">
            ...
            <li>
                <a href="javascript:void(0);">景区资讯列表</a>
            </li>
            <li>
                <a href="<?php echo base_url(); ?>admin/news/edit/<?php echo $id ?>">编辑景区资讯</a>
            </li>
        </ul>
    </div>
    <div class="row">
        <div class="box col-md-12">
            <div class="box-inner">
                ...
                <div class="box-content">
                    <form id="frmContent" role="form" method="POST" action="<?php echo base_url(); ?>admin/news/edit/<?php echo $id ? $id : ''; ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="txtHits">点击/阅读数</label>
                            <input name="hits" type="text" class="form-control" id="txtHits" placeholder="点击/阅读数" value="<?php echo $hits ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="txtPublishedTimestamp">发布时间</label>
                            <div class='input-group date'>
                                <input name="publishedTimestamp" type='text' class="form-control" placeholder="发布时间" id="txtPublishedTimestamp"/>
                        ...
                        <a class="btn btn-primary" href="<?php echo base_url();?>admin/news">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#txtPublishedTimestamp').datetimepicker({
            locale:'zh-cn'
        });
        $('#txtPublishedTimestamp').keypress(function() {
//            var key = e.charCode || e.keyCode || e.which;
            return false;
        });

        $('#txtPublishedTimestamp').val('<?php echo $publishedTimestamp ?>');

        $("#txtHits").keydown(function(event) {
