    ...
    public function ajaxForum()
    {
        ...
        foreach ($result['data'] as $k => $v){
            ...
            foreach ($v['jottingImages'] as $k1 => $v1){
                $html .= '<figure class="img-1  col-xs-6 col-sm-6" itemscope itemtype="http://schema.org/ImageObject"><a href="'.$v1.'" itemprop="contentUrl" data-size="1024x1024"><img src="'.$v1.'" width="100%" class=" padding-1" style="min-height:100px;" itemprop="thumbnail" alt="Image description" /></a></figure>';
            }
