    ...
    public function ajaxForum()
    {
        ...
        foreach ($result['data'] as $k => $v){
            ...
            foreach ($v['jottingImages'] as $k1 => $v1){
                $html .= '<figure class="img-1" itemscope itemtype="http://schema.org/ImageObject"><a href="https://farm4.staticflickr.com/3894/15008518202_b016d7d289_b.jpg" itemprop="contentUrl" data-size="1024x1024"><img src="'.$v1.'" width="100%" class=" padding-1" itemprop="thumbnail" alt="Image description" style="width:115px; height:105px;" /></a></figure>';
            }
